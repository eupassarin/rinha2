...
CREATE UNLOGGED TABLE IF NOT EXISTS TRANSACAO_1  PARTITION OF TRANSACAO FOR VALUES IN (1);
CREATE UNLOGGED TABLE IF NOT EXISTS TRANSACAO_2  PARTITION OF TRANSACAO FOR VALUES IN (2);
CREATE UNLOGGED TABLE IF NOT EXISTS TRANSACAO_3  PARTITION OF TRANSACAO FOR VALUES IN (3);
CREATE UNLOGGED TABLE IF NOT EXISTS TRANSACAO_4  PARTITION OF TRANSACAO FOR VALUES IN (4);
CREATE UNLOGGED TABLE IF NOT EXISTS TRANSACAO_5  PARTITION OF TRANSACAO FOR VALUES IN (5);
