CREATE UNLOGGED TABLE IF NOT EXISTS CLIENTE (ID SERIAL PRIMARY KEY,LIMITE INT NOT NULL,SALDO INT DEFAULT 0);
...
CREATE PROCEDURE TRANSACIONAR(
    ...
    INOUT R_LIMITE INT DEFAULT NULL)
LANGUAGE plpgsql
AS $$
BEGIN
  UPDATE CLIENTE
  ...
  RETURNING SALDO, LIMITE INTO NOVO_SALDO, R_LIMITE;
